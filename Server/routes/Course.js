...
const { createCourse,updateCourse, getAllCourses, getCourseDetails,getInstructorCourses,deleteCourse,getFullCourseDetails,getAllCompletedLectures } = require("../controllers/Course");
...
router.post('/getAllCompletedLectures', auth, isStudent, getAllCompletedLectures);
// Edit Course routes
